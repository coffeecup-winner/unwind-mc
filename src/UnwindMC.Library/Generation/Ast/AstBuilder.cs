...
using UnwindMC.Generation.Ast.Transformations;
using UnwindMC.Util;
...
namespace UnwindMC.Generation.Ast
{
    public class AstBuilder
    {
        ...
        private readonly IReadOnlyList<Analysis.Data.Type> _parameterTypes;
        private readonly IReadOnlyList<Analysis.Data.Type> _localTypes;
        private readonly IReadOnlyList<Analysis.Data.Type> _variableTypes;
        ...
        private Dictionary<string, Analysis.Data.Type> _types;
        
        public AstBuilder(IReadOnlyList<IBlock> blocks, IReadOnlyList<Analysis.Data.Type> parameterTypes,
            IReadOnlyList<Analysis.Data.Type> localTypes, IReadOnlyList<Analysis.Data.Type> variableTypes)
        {
            _blocks = blocks;
        ...
        public ScopeNode BuildAst()
        {
            ...
            _types = new Dictionary<string, Analysis.Data.Type>();
            int offset = 0;
