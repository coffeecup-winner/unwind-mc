...
namespace UnwindMC.Analysis
{
    ...
    public class Analyzer
    {
        ...
        private readonly IImportResolver.IImportResolver _importResolver;
        ...
        public Analyzer(ArraySegment<byte> textBytes, ulong pc, IImportResolver.IImportResolver importResolver)
        {
